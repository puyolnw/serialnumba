  ...
  const fetchActivities = async () => {
    try {
      ...
      if (res?.data?.success) {
        ...
        // Debug each activity's participant count
        activitiesData.forEach(activity => {
          console.log(`🎯 Activity ${activity.id} (${activity.title}): participant_count = ${activity.participant_count}`);
        });
        ...
        <div className="staff-header">
          <div className="d-flex justify-content-between align-items-center">
            <div>
              ...
              <p className="text-muted mb-0">ดูข้อมูลกิจกรรมทั้งหมดในระบบ</p>
            </div>
                              ...
                              <div className="d-grid gap-2">
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    alert('คัดลอกลิงก์ลงทะเบียนแล้ว!')
                                  }}
                                >
