...
const StaffActivityReports = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await api.get('/admin/reports/staff/activities', { params: filters });
  ...
  const exportToExcel = async () => {
    try {
      const response = await api.get('/admin/reports/staff/activities/export/excel', {
        params: filters,
        responseType: 'blob'
      });
  ...
  const exportToPDF = async () => {
    try {
      const response = await api.get('/admin/reports/staff/activities/export/pdf', {
        params: filters,
        responseType: 'blob'
      });
            ...
            <div className="col-md-3">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center">
                  ...
                  <h4 className="text-success mb-1">{data.summary?.totalActivities || 0}</h4>
            ...
            <div className="col-md-3">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center">
                  ...
                  <h4 className="text-primary mb-1">{data.summary?.completedActivities || 0}</h4>
            ...
            <div className="col-md-3">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center">
                  ...
                  <h4 className="text-warning mb-1">{typeof data.summary?.averageRating === 'number' ? data.summary.averageRating.toFixed(1) : (parseFloat(data.summary?.averageRating) || 0).toFixed(1)}</h4>
                            ...
                            <td>
                              <span className={`badge ${
                                ...
                                {activity.status === 'CLOSED' ? 'เสร็จสิ้น' :
                                 ...
                                 activity.status === 'DRAFT' ? 'ร่าง' : activity.status}
                              </span>
                            </td>
                          </tr>
                        ))}
